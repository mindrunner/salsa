...
This repository contains Harmonic's fork of Jito's fork of the Solana validator.

We recommend checking out our [Quick Start](https://docs.harmonic.gg/quickstart) for
more detailed instructions on building and running Harmonic Salsa.
